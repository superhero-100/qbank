...
public class BaseUserDao {
    ...
    public BaseUserViewPageDto findFilteredUsers(UserFilterDto filter) {
        ...
        List<BaseUserDetailsDto> baseUserDetailsDtoList = results.stream()
                .map(user -> BaseUserDetailsDto.builder()
                        .id(user.getId())
                        ...
                        .build())
                .toList();
        BaseUserViewPageDto baseUserViewPage = new BaseUserViewPageDto();
