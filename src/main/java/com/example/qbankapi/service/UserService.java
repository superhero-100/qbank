...
import com.example.qbankapi.dto.model.UserEnrolledExamDetailsDto;
import com.example.qbankapi.dto.model.UserProfileStatsDto;
...
//    }
    ...
    @Transactional(readOnly = true)
    public List<UserEnrolledExamDetailsDto> getAllEnrolledExamDtos(Long id) {
        User user = userDao.findById(id).orElseThrow(() -> new UserNotFoundException(String.format("User not found with id: %d",id)));
