...
//        // ex name
//        ParticipantUserExamResult participantUserExamResult = userExamResultDao.findById(id).orElseThrow(() -> new ParticipantUserExamResultNotFoundException(String.format("UserExamResult not found with id: %d", id)));
